...
guildrooms={}
guilds={
	'Merchant'  :  Guild('Merchant',  3, 4, { 'Escort':1, 'Cargo' :2, 'Defend':1, 'Rescue':2 }, 1000.00, '#G#', '\n\n\n\nMission accepted.\n\nThank you.', []),  #["merchant"]), #no more tech, [] instead
	'Mercenary' :  Guild('Mercenary', 3, 4, { 'Scout':1, 'Bounty':2, 'Patrol':1, 'Attack':1 }, 5000.00, '#G#', '\n\n\n\nMission accepted.\n\nThank you.', []),  #["hunter"]) # no more tech, [] instead
	'Computer'  :  Guild('Computer',  4, 6, { 'Scout':1, 'Rescue':1, 'Cargo' :2, 'Patrol':2, 'Defend':1, 'Bounty':2, 'Attack':1, 'Escort':1 }, 0, '#C#', '\n\n\n\nMission accepted.\n\nThank you.', [])              # Base computer interface (it's a guild - go figure)
	}
