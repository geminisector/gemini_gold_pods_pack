...
fortress_systems={"Gemini/Perry":1-.0625, "Gemini/New_Constantinople":1-.0625, "Gemini/New_Detroit":1-.0625, "Gemini/Troy":.3125,"Gemini/Tingerhoff":.3125,"Gemini/XXN-1927":.3125,"Gemini/Junction":.3125,"Gemini/Eden":1.0,"Gemini/Beta":1.0,"Gemini/Delta":1.0,"Gemini/Gamma":1.0,"Gemini/Palan":1.0,"Gemini/Delta_Prime":1.0,"Gemini/Oxford":1.0,"Gemini/Pentonville":1.0,"Gemini/Tr_Pakh":0.5}
...
staticFighterProduction={"retro":10, "pirates":10, "hunter":5, "confed":5, "militia":5, "merchant":5, "kilrathi":5}
fighterProductionRate=  {"confed":5
                        ,"landreich":.12
                        ,"border_worlds":.06
                        ,"kilrathi":5
                        ,"retro":5
...
production_centers={"confed":["Gemini/Perry","Gemini/New_Detroit"]
                ...
                ,"nephilim":["Enigma/Shanha"]
                ,"pirates":["Gemini/Pentonville","Gemini/Sherwood","Gemini/Penders_Star","Gemini/Capella","Gemini/Telar","Gemini/KM-252"]
...
enemies =  ((kilrathi,pirates,kilrathi,retro,pirates,retro), #confed
            ...
            (pirates,pirates,retro,pirates,pirates,kilrathi,retro,pirates,pirates,pirates,pirates,kilrathi,retro), #merchant
            (pirates,militia,confed,merchant,kilrathi,hunter,hunter,hunter), #retro
            (confed,militia,militia,militia,retro,kilrathi,merchant,merchant,retro,merchant,merchant,merchant,merchant,merchant,merchant), #pirates
            (kilrathi,kilrathi,retro,retro,pirates,pirates), #hunter
            (pirates,retro,pirates,kilrathi,retro,pirates), #militia
...
fighters = (("stiletto","stiletto","broadsword",), #confed
            ("dralthi","dralthi","gothri",), #kilrathi  
            ("steltek_fighter",), #nephilim
            ("tarsus","tarsus","galaxy","galaxy","galaxy","orion",), #merchant
            ("talon","talon","talon.retro2",), #retro
            ("talon","talon","talon.pirlaser","talon.pirmeson",), #pirates
            ("demon","demon","demon","orion.hunter","centurion",), #hunter
...
stattable={
	...
	"refinery":(0,0,0,800,0),
        "talon.retro2":(0.45,0.38,18.77,36,32),
        "talon.pirmeson":(0.45,0.38,18.77,36,32),
        "talon.pirlaser":(0.45,0.38,18.77,36,32),
        }
...
def GetStats ( name):
    try:
        ...
        print 'GetStats: cannot find '+name
        return (.5,.5,1,1,1)
